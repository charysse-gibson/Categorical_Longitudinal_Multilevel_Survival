...
DATALINES;
1  1  2  1 1  2  3 1 1 3  6  1 1 4 6 1 1 5  7  1
1 6 10 1 1 7 15 1 1 8 15 1 1 9 16 1 1 10 27 1 1 11 30 1 1 12  32  1  
2 21 1 1 2 22 1 1   2 23 1 1  2 24 1 1  2 25 2 1  2 26 3 1  2  27  3 1  2 28 9 1  2 29  22 1
;
...
PROC LIFETEST PLOTS=s(test atrisk);
     TIME month*death(0); 
     STRATA agegrp/Tests=wilcoxon;
	RUN;
**Note: 1) test command shows logrank test results on the plot. 
	2) atrisk command shows risk set size on the X-axis. 
	3) a STRATA statement does three tests
    4) you can specify a test by adding /Tests=wilcoxon;

/* Data from Klein & Moeschberger (1997)*/
proc format; value risk 1='ALL' 2='low-risk AML' 3='high-risk AML'; 
data BMT; 
input Group T Status @@; 
format Group risk.; label T='Time to Relapse'; 
datalines; 
1 2081 0 1 1602 0 1 1496 0 1 1462 0 1 1433 0 1 1377 0 1 1330 0 1 996 0 1 226 0 1 1199 0 
1 1111 0 1 530 0 1 1182 0 1 1167 0 1 418 1 1 383 1 1 276 1 1 104 1 1 609 1 1 172 1 1 487 1 
1 662 1 1 194 1 1 230 1 1 526 1 1 122 1 1 129 1 1 74 1 1 122 1 1 86 1 1 466 1 1 192 1 1 109 1 
1 55 1 1 1 1 1 107 1 1 110 1 1 332 1 2 2569 0 2 2506 0 2 2409 0 2 2218 0 2 1857 0 2 1829 0 
2 1562 0 2 1470 0 2 1363 0 2 1030 0 2 860 0 2 1258 0 2 2246 0 2 1870 0 2 1799 0 2 1709 0 
2 1674 0 2 1568 0 2 1527 0 2 1324 0 2 957 0 2 932 0 2 847 0 2 848 0 2 1850 0 2 1843 0 2 1535 0 
2 1447 0 2 1384 0 2 414 1 2 2204 1 2 1063 1 2 481 1 2 105 1 2 641 1 2 390 1 2 288 1 2 421 1 
2 79 1 2 748 1 2 486 1 2 48 1 2 272 1 2 1074 1 2 381 1 2 10 1 2 53 1 2 80 1 2 35 1 2 248 1 
2 704 1 2 211 1 2 219 1 2 606 1 3 2640 0 3 2430 0 3 2252 0 3 2140 0 3 2133 0 3 1238 0 3 1631 0 
3 2024 0 3 1345 0 3 1136 0 3 845 0 3 422 1 3 162 1 3 84 1 3 100 1 3 2 1 3 47 1 3 242 1 3 456 1 
3 268 1 3 318 1 3 32 1 3 467 1 3 47 1 3 390 1 3 183 1 3 105 1 3 115 1 3 164 1 3 93 1 3 120 1 
3 80 1 3 677 1 3 64 1 3 168 1 3 74 1 3 16 1 3 157 1 3 625 1 3 48 1 3 273 1 3 63 1 3 76 1 3 113 1 3 363 1 
; 
Run;
Proc lifetest data=BMT notable plots=s(atrisk); 
    time T * Status(0); 
    strata Group / adjust=Tukey; **Sidak test;
	title "the Tukey�s test for multiple-comparison adjustment";
   run; 
*Multiple grouping variables allowed in Strata;
...
proc lifetest notable;
	...
	Test ulcer clark thickness;
run;
proc lifetest plots=s(atrisk cb=hw) notable;
     time months*censor(0); 
	 strata ulcer;
	Test clark thickness;
run;
