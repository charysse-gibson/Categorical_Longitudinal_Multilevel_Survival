...
proc phreg data=methadone1; 
   ...
   output out=methadone2 		
            ld=likedisp lmax=lmaxdisp survival=surv;
...
run;
proc sort data=methadone2; by descending likedisp;
proc print data=methadone2 (obs=10); var patientid likedisp dose clinic prison; *id=1;
run;
proc sort data=methadone2; by descending lmaxdisp;
proc sgplot data=methadone2;
...
run;
proc sort data=methadone2; by descending lmaxdisp;
proc print data=methadone2 (obs=10); var patientid lmaxdisp dose clinic prison; *id=1;
run;
...
run;
proc sort data=methadone2; by scoredose;
proc print data=methadone2 (obs=5); var patientid scoredose dose; where scoredose ne . ; *id=1;
run;
proc sort data=methadone2; by descending scoredose;
proc print data=methadone2 (obs=5); var patientid scoredose dose; *id=1;
run;
...
proc sort data=methadone2; by dfdose;
proc print data=methadone2 (obs=5); var patientid dfdose dose; where dfdose ne . ; 
title 'Assessment Plot of DFBETA';
run;
proc sort data=methadone2; by descending dfdose;
proc print data=methadone2 (obs=5); var patientid dfdose dose; 
title 'Assessment Plot of DFBETA';
run;
***Practice exercise 3***;
